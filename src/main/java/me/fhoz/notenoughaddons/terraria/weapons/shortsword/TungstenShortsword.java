...
public class TungstenShortsword extends SimpleSlimefunItem<WeaponUseHandler> {
    private static final double DAMAGE = 10;
    private static final double KNOCKBACK = 4;
    private static final double CRIT_CHANCE = 0.04;
    private static final int USE_TIME = 11;

    @ParametersAreNonnullByDefault
    public TungstenShortsword(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
