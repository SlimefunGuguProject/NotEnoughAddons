...
public class SilverShortsword extends SimpleSlimefunItem<WeaponUseHandler> {
    ...
    public SilverShortsword(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
