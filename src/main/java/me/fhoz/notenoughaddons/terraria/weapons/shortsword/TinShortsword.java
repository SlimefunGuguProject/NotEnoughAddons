...
public class TinShortsword extends SimpleSlimefunItem<WeaponUseHandler> {
    ...
    public TinShortsword(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
