...
public class IronShortsword extends SimpleSlimefunItem<WeaponUseHandler> {
    ...
    public IronShortsword(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
