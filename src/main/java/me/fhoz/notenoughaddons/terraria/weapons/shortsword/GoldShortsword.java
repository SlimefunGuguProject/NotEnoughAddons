...
public class GoldShortsword extends SimpleSlimefunItem<WeaponUseHandler> {
    ...
    public GoldShortsword(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
